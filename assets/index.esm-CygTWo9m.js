 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ye{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(n=>{if(Xe(n)){const r=n.getImmediate();return`${r.library}/${r.version}`}else return null}).filter(n=>n).join(" ")}}function Xe(t){return t.getComponent()?.type==="VERSION"}const A="@firebase/app",H="0.14.13";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function kt(t){F(new w("platform-logger",e=>new Ye(e),"PRIVATE")),F(new w("heartbeat",e=>new Ht(e),"PRIVATE")),I(A,H,t),I(A,H,"esm2020"),I("fire-js","")}kt("");export{jt as A,rn as B,w as C,B as D,Kt as E,S as F,I as G,sn as H,l as L,Qt as S,J as _,Le as a,Yt as b,m as c,Zt as d,E as e,vt as f,ce as g,qt as h,wt as i,F as j,Xt as k,_ as l,Ut as m,$ as n,Tt as o,tn as p,nn as q,zt as r,be as s,Gt as t,Vt as u,Ot as v,en as w,Jt as x,Ie as y,Wt as z};
